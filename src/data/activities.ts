...
export const activities: Activity[] = [
  {
    ...
    category: "K-Culture",
    title: "한국 전통 놀이 체험",
    description: "달고나 만들기, 제기차기, 공기놀이 등 한국 전통 놀이 체험",
    icon: "🇰🇷",
    color: "bg-blue-500",
    details: [
      "달고나 만들기",
  ...
  },
  {
    ...
    category: "K-Beauty",
    title: "K-Beauty 체험",
    description: "마스크팩, 네일, 파우치 꾸미기, 키링 만들기 등 K-Beauty 체험",
    icon: "💅",
    color: "bg-pink-500",
    details: [
      "마스크팩",
  ...
  },
  {
    ...
    category: "K-Food",
    title: "한국 대표음식 체험",
    description: "로제 떡볶이, 미숫가루, 화채 등 한국 음식 체험",
    icon: "🍳",
    color: "bg-orange-500",
    details: [
      "로제 떡볶이",
